    ...
    (meta, abilities, proficiencies, inventory, spells, vitals, playState,
     ...
     maxHp, acInfo, allSources, staticData) => {
        ...
        const fullCharacter: Character = {
            ...
            swimmingSpeed: 0,
            climbingSpeed: 0,
            passivePerception: 10 + modifiers.WISDOM, // placeholder
            passiveInvestigation: 10 + modifiers.INTELLIGENCE, // placeholder
            encumbranceStatus: 'none', // placeholder
